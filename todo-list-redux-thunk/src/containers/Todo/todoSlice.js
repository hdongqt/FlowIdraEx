...
// create thunk action
export const getListTodo = createAsyncThunk("todos/getListTodo",
...
export const addNewTodoFilter = createAsyncThunk("todos/addNewTodoFilter",
    async (todo, thunkAPI) => {
        try {
...
export const editTodoFilter = createAsyncThunk("todos/editTodoFilter",
    async (todo, thunkAPI) => {
        try {
            if (todo.title.includes("từ bậy")) todo.title = "Công việc vui vẻ";
