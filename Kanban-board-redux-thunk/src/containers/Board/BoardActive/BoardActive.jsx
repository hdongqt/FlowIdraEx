            ...
            <BoardList>
                {list.map((todo) => (
                    ...
                    >
                        ...
                        <BoardIcon onClick={() => dispatch(setEditTask(todo.id))} top={"10px"} right={"35px"}
                                   color={"blue"}>
                        ...
                        <BoardInfoTask>
                            <BoardInfoType>
                                ...
                                <div>
                                    {todo.priority_type === "LOWEST" &&
                                        <img src={lowest} alt={todo.priority_type}></img>}
                                    {todo.priority_type === "LOW" && <img src={low} alt={todo.priority_type}></img>}
                                    {todo.priority_type === "MEDIUM" &&
                                        <img src={medium} alt={todo.priority_type}></img>}
                                    {todo.priority_type === "HIGH" && <img src={high} alt={todo.priority_type}></img>}
                                    {todo.priority_type === "HIGHEST" &&
                                        <img src={highest} alt={todo.priority_type}></img>}
                                </div>
                            </BoardInfoType>
